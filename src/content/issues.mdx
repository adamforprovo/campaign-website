...
To keep Provo thriving for years to come, we need to build a resilient economy and plan for our future.
...
Putting off maintenance saves money now, but it's not sustainable. Without a plan, we're passing the bill on to the future.
...
**Big projects cost money and come with risk.** Some of these bets have paid off, but others may take years to prove themselves. They’re difficult to change once built, even if the payoff falls short.

### It's time to get the fundamentals right.

Most of Provo's neighborhoods depend on subsidy. The property and sales tax they generate don't cover the long-term cost of the roads and pipes that service them.

To balance the budget, we need to help these places become more economically self-sustaining.

**A strong economy isn't built on a handful of big ideas — it's built on hundreds of small ones.** Sprawling developments and speculative projects stretch our resources. But small businesses, infill projects, and mixed-use developments make better use of the infrastructure we've already built. 

When we invest in existing places, we get a better return on our money. This kind of incremental growth built Provo in the first place, and it can move us forward today.
